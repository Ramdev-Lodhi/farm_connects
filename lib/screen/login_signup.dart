...
class _LoginSignupScreenState extends State<LoginSignupScreen> {
  ...
  Container buildSigninSection() {
    return Container(
      ...
      child: Column(
        children: [
          buildTextField(FontAwesomeIcons.phone, "0123456789", false, TextInputType.number),
          buildTextField(FontAwesomeIcons.lock, "**********", true, TextInputType.text),
          Row(
  ...
  Container buildSignupSection() {
    return Container(
      ...
      child: Column(
        children: [
          buildTextField(FontAwesomeIcons.user, "User Name", false, TextInputType.text),
          buildTextField(FontAwesomeIcons.phone, "phone", false, TextInputType.number),
          buildTextField(FontAwesomeIcons.addressCard, "address", false, TextInputType.text),
          buildTextField(FontAwesomeIcons.locationPin, "pincode", false, TextInputType.number),
          buildTextField(FontAwesomeIcons.lock, "password", true, TextInputType.text),
          Padding(
  ...
  Widget buildTextField(
      IconData icon, String hintText, bool isPassword, TextInputType keyboardType) {
    return Padding(
